...
class os_demod_decode(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.msg_connect((self.satellites_check_address_0, 'ok'), (self.satellites_pdu_head_tail_0, 'in'))
        ...
        self.connect((self.blocks_unpacked_to_packed_xx_0_0_0_0, 0), (self.pdu_tagged_stream_to_pdu_0, 0))
